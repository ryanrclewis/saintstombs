...
const routeMetadata = {
  '/home': {
    title: 'SaintsTombs | Journey to the Sacred',
    description:
      'Explore the final resting places of the world\'s most revered holy figures, shrines, and sacred sites.',
  },
  '/saints': {
  ...
  '/regions': {
    ...
    description: 'Browse saints and holy figures by geographic region.',
  },
  '/about': {
  ...
  '/admin': {
    title: 'Admin | SaintsTombs',
    description: 'Edit region content files.',
  },
} as const
